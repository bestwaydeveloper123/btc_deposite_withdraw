...
class Fixer
{
  ...
  function get_rates($base_code, $extra_code) {
      ...
      //dump_exit($extra_code);
    
      //$url = "https://api.fixer.io/latest?access_key=5c9b284890233080ef77de7b421bf2e8&format=1";
      $url = "http://data.fixer.io/api/latest?access_key=5c9b284890233080ef77de7b421bf2e8&format=1";
    ...
    function get_btc_rate() {
      $rate = $this->Cryptapi_model->get_current_rate();
      return $rate;
    }
