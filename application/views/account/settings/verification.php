...
$( document ).ready(function() {
  ...
  $("#bdayf").birthdayPicker({
    ...
    placeholder: true,
    defaultDate: false,
    sizeClass: "span1 form-control"
    });	
    <?php if ($return['b_day'] != '') { ?>
    $("select[name='bdayf_birth[day]']").val("<?php print $return['b_day']; ?>");    
    <?php } ?>
     <?php if ($return['b_month'] != '') { ?>
    $("select[name='bdayf_birth[month]']").val("<?php print $return['b_month']; ?>");    
    <?php } ?>
     <?php if ($return['b_year'] != '') { ?>
    $("select[name='bdayf_birth[year]']").val("<?php print $return['b_year']; ?>");    
    <?php } ?>
});
...
if ($user['zip'] == '') {$user['zip'] = $return['zip'];}
if ($user['city'] == '') {$user['city'] = $return['city'];}
if ($user['address_1'] == '') {$user['address_1'] = $return['address'];}
if ($user['phone'] == '') {$user['phone'] = $return['phone'];}
      ...
      <div class="col-md-12 mt-3">
          <?php //dump($return); ?>
             <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="exampleInputEmail1"><?php echo lang('core button bday'); ?>*</label>
                <input type="text" class="form-control datepicker" name="bday" id="bday" value=""  autocomplete="off">
              </div>
               */ ?>
              <div class="form-group col-md-6">
                <label for="company"><?php echo lang('users settings company'); ?></label>
                <input type="text" class="form-control <?php form_error('users settings company') ? ' is-invalid' : ''; ?>" name="company" id="company" value="<?php echo $return['company']; ?>">
              </div>
              <div class="form-group col-md-6">
               ...
               <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control <?php echo form_error('users settings address_1') ? ' is-invalid' : ''; ?>" name="address_1" id="address_1" value="<?php echo $return['address_1']; ?>">
              </div>
               <div class="form-group col-md-6">
                <label for="city"><?php echo lang('users settings address_2'); ?></label>
                <input type="text" class="form-control <?php echo form_error('users settings address_2') ? ' is-invalid' : ''; ?>" name="address_2" id="address_2" value="<?php echo $return['address_2']; ?>">
              </div>
               <div class="form-group col-md-6">
                <label for="country"><?php echo lang('users input phone'); ?>*</label>
                <input type="text" class="form-control <?php echo form_error('users input phone') ? ' is-invalid' : ''; ?>" name="phone" id="phone" value="<?php echo $return['phone']; ?>">
              </div>
               <div class="col-md-10">
