  ...
  <div class="card-body">
    <div class="row">
      <div class="form-group col-md-12">
         ...
         <input type="text" class="form-control" name="name" id="name" placeholder="My merchant name">
      </div>
      <div class="form-group col-md-6">
         <label for="email"><?php echo lang('users merchants url'); ?></label>
         <input type="text" class="form-control" name="link" id="link" placeholder="https://mywebsite.com">
      </div>
      <div class="form-group col-md-6">
         <label for="email"><?php echo lang('users merchants ipn'); ?></label>
         <input type="text" class="form-control" name="status_link" id="status_link" placeholder="https://mywebsite.com/status">
      </div>
      <div class="form-group col-md-6">
         <label for="email"><?php echo lang('users shops merchant_success'); ?></label>
         <input type="text" class="form-control" name="success_link" id="success_link" placeholder="https://mywebsite.com/success">
      </div>
      <div class="form-group col-md-6">
         <label for="email"><?php echo lang('users shops merchant_fail'); ?></label>
         <input type="text" class="form-control" name="fail_link" id="fail_link" placeholder="https://mywebsite.com/fail">
      </div>
      <div class="form-group col-md-6">
