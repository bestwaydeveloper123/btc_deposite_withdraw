...
<div class="row">
  <div class="col-md-4 mb-2">
    <h5><?php echo lang('users invoices all'); ?></h5>
  </div>
          ...
          <div class="card card-body">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <?php echo form_input(array('name'=>'datefrom', 'id'=>'datefrom', 'class'=>'form-control datepicker-here', 'placeholder'=> 'YYYY-MM-DD',  'value'=>set_value('datefrom', ((isset($filters['datefrom'])) ? $filters['datefrom'] : '')))); ?>
              </div>
                <div class="form-group col-md-6">
                <label for="id"><?php echo lang('users trans dateto'); ?></label>
                <?php echo form_input(array('name'=>'dateto', 'id'=>'dateto', 'class'=>'form-control datepicker-here', 'placeholder'=> 'YYYY-MM-DD',  'value'=>set_value('dateto', ((isset($filters['dateto'])) ? $filters['dateto'] : '')))); ?>
              </div>
                <div class="form-group col-md-6">
                ...
                <tr>
                  ...
                  <td> <?if($view['status']==1){?>
                                  ...
                                  <?php 
                                   ...
                                   if ($view['receiver'] == $this->session->userdata['logged_in']['username']) { ?>
...
<div class="container" style="margin-top:50px;margin-bottom:50px;">
    ...
    <div class="row">
        <div class="col"><center><i class="far fa-keyboard fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description invoices_1'); ?></center>
        </div>
          <div class="col"><center><i class="fas fa-pencil-alt fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description invoices_2'); ?></center>
        </div>
          <div class="col"><center><i class="far fa-file-alt fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description invoices_3'); ?></center>
        </div>
      </div>
</div> 