        ...
        <div class="collapse mb-3" id="search">
          <div class="card card-body">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="id"><?php echo lang('users dispute datefrom'); ?></label>
                <?php echo form_input(array('name'=>'time_dispute_from', 'id'=>'time_dispute_from', 'class'=>'form-control datepicker-here', 'placeholder'=> 'YYYY-MM-DD',  'value'=>set_value('time_dispute_from', ((isset($filters['time_dispute_from'])) ? $filters['time_dispute_from'] : '')))); ?>
              </div>
              <div class="form-group col-md-6">
                <label for="id"><?php echo lang('users dispute dateto'); ?></label>
                <?php echo form_input(array('name'=>'time_dispute_to', 'id'=>'time_dispute_to', 'class'=>'form-control datepicker-here', 'placeholder'=> 'YYYY-MM-DD',  'value'=>set_value('time_dispute_to', ((isset($filters['time_dispute_to'])) ? $filters['time_dispute_to'] : '')))); ?>
              </div>
              <div class="form-group col-md-6">
            ...
            <td>
              ...
              <td class="text-center">
                <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <?php /* <a class="btn btn-outline-info btn-sm" data-toggle="collapse" href="#id-<?php echo $view['id']; ?>" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="icon-info icons"></i></a>*/ ?>
                </div>
              </td>
           </tr>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <h6>
                                    ...
                                    <?}else{?>
                                    <?}?><?if($view['title'] == 3){?>
                                      <?php echo lang('users history not_authorized'); ?>
                                    <?}else{?>
                                    <?}?>
                                  </h6>
                                  <p>
...
<div class="container" style="margin-top:50px;margin-bottom:50px;">
    ...
    <div class="row">
        <div class="col"><center><i class="fas fa-exclamation-triangle fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description disputes_1'); ?></center>
        </div>
          <div class="col"><center><i class="icon-eye icons fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description disputes_2'); ?></center>
        </div>
          <div class="col"><center><i class="icon-support NavIcon fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description disputes_3'); ?></center>
        </div>
      </div>
</div> 