...
$( document ).ready(function() {
  ...
  $(document).on("click","#cur_alert_hide",function(event) { 
     $( "#cur_alert").hide();
  });
  
  $(document).on("click",".planes-radio",function(event) { 
    var cur1 = $( "#currency option:selected" ).val();
    var method_text = $(this).val();
      if (method_text == 'blockchain') {var method = 10;}
      if (method_text == 'swift') {var method = 7;}
      if (method_text == 'payeer') {var method = 4;}
      if (method_text == 'yandex') {var method = 8;}
      if (method_text == 'epay') {var method = 5;}
      //console.log(cur1);
      //console.log(method_text);
      
      $.post( "/ajax/check_dcur_method", { input_cur: cur1, method: method })
        .done(function( data ) {
          //console.log(data);
          data = $.parseJSON(data);
          
          if (data.status == 0) {//switch to m
            //console.log(data);
            $( "#cur_alert").show();
            $( "#currency" ).val(data.cur[0]);
          }
        });
  });
...
<div class="card">
  <div class="card-body">
    <div class="alert alert-warning alert-dismissible fade show" role="alert" style="display:none;" id="cur_alert">
      <?php echo lang('users deposit error_5'); ?>
      <button type="button" class="close" data-hide="alert" aria-label="Close" id="cur_alert_hide">
      <span aria-hidden="true">×</span>
      </button>
	</div>  
    <div class="row">
        <div class="form-group col-md-12">
            <?php echo lang('users deposit description'); ?>
        </div>
    </div>
    <div class="row">
          ...
          <div class="plan-card-group">
            <?php if ($paypal['status'] == 1) : ?>
             ...
             <?php if ($swift['status'] == 1) : ?>
              ...
              <?php if ($yandex['status'] == 1) : ?>
              <div class="radio-card">
                <input type="radio" class="planes-radio" name="method" value="yandex" id="full-marca-blanca18"/>
                <label for="full-marca-blanca18" id="radio-label18">
                  <div class="row">
                    <div class="col-md-1 mt-3 mb-3 text-center">
                      <img src="<?php echo base_url();?>assets/themes/account/img/pay-icon/yandex.png" class="win-img">
                    </div>
                     <div class="col-md-8 mt-12px mb-3">
                      <h5 class="mb-0">
                        <?php echo $yandex['name']; ?>
                      </h5>
                       <?if($enabled_yandex == FALSE){?>
                       <small class="text-danger"><?php echo lang('users withdrawal verify_error'); ?></small>
                       <?}else{?><small class="text-muted"><?php echo lang('users withdrawal available'); ?> 
                           
                       <?if($yandex['debit_base'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $yandex['minimum_debit_base']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $yandex['maximum_debit_base']; ?>"><?php echo $this->currencys->display->base_code ?></a><?}else{?><?}?> <?if($yandex['debit_extra1'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $yandex['minimum_debit_extra1']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $yandex['maximum_debit_extra1']; ?>"><?php echo $this->currencys->display->extra1_code ?></a><?}else{?><?}?> <?if($yandex['debit_extra2'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $yandex['minimum_debit_extra2']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $yandex['maximum_debit_extra2']; ?>"><?php echo $this->currencys->display->extra2_code ?></a><?}else{?><?}?> <?if($yandex['debit_extra3'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $yandex['minimum_debit_extra3']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $yandex['maximum_debit_extra3']; ?>"><?php echo $this->currencys->display->extra3_code ?></a><?}else{?><?}?> <?if($yandex['debit_extra4'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $yandex['minimum_debit_extra4']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $yandex['maximum_debit_extra4']; ?>"><?php echo $this->currencys->display->extra4_code ?></a><?}else{?><?}?> <?if($yandex['debit_extra5'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $yandex['minimum_debit_extra5']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $yandex['maximum_debit_extra5']; ?>"><?php echo $this->currencys->display->extra5_code ?></a><?}else{?><?}?></small><?}?>
                    </div>
                   <div class="col-md-3 mt-22px mb-3 text-right">
                     <span class="badge badge-secondary"><?php echo $yandex['fee']; ?>% + <?php echo $yandex['fee_fix']; ?></span>
                   </div>
                  </div>
                </label>
              </div>
              ...
              <?php if ($epay['status'] == 1) : ?>
              <div class="radio-card">
                <input type="radio" class="planes-radio" name="method" value="epay" id="full-marca-blanca15"/>
                <label for="full-marca-blanca15" id="radio-label15">
                  <div class="row">
                    <div class="col-md-1 mt-3 mb-3 text-center">
                      <img src="<?php echo base_url();?>assets/themes/account/img/pay-icon/epay.png" class="win-img">
                    </div>
                     <div class="col-md-8 mt-12px mb-3">
                      <h5 class="mb-0">
                        <?php echo $epay['name']; ?>
                      </h5>
                       <?if($enabled_epay == FALSE){?><small class="text-danger"><?php echo lang('users withdrawal verify_error'); ?></small><?}else{?><small class="text-muted"><?php echo lang('users withdrawal available'); ?> <?if($epay['debit_base'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $epay['minimum_debit_base']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $epay['maximum_debit_base']; ?>"><?php echo $this->currencys->display->base_code ?></a><?}else{?><?}?> <?if($epay['debit_extra1'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $epay['minimum_debit_extra1']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $epay['maximum_debit_extra1']; ?>"><?php echo $this->currencys->display->extra1_code ?></a><?}else{?><?}?> <?if($epay['debit_extra2'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $epay['minimum_debit_extra2']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $epay['maximum_debit_extra2']; ?>"><?php echo $this->currencys->display->extra2_code ?></a><?}else{?><?}?> <?if($epay['debit_extra3'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $epay['minimum_debit_extra3']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $epay['maximum_debit_extra3']; ?>"><?php echo $this->currencys->display->extra3_code ?></a><?}else{?><?}?> <?if($epay['debit_extra4'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $epay['minimum_debit_extra4']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $epay['maximum_debit_extra4']; ?>"><?php echo $this->currencys->display->extra4_code ?></a><?}else{?><?}?> <?if($epay['debit_extra5'] == 1){?><a href="#" data-tooltip="<?php echo lang('users withdrawal minimum'); ?>: <?php echo $epay['minimum_debit_extra5']; ?> <?php echo lang('users withdrawal maximum'); ?>: <?php echo $epay['maximum_debit_extra5']; ?>"><?php echo $this->currencys->display->extra5_code ?></a><?}else{?><?}?></small><?}?>
                    </div>
                   <div class="col-md-3 mt-22px mb-3 text-right">
                     <span class="badge badge-secondary"><?php echo $epay['fee']; ?>% + <?php echo $epay['fee_fix']; ?></span>
                   </div>
                  </div>
                </label>
              </div>
