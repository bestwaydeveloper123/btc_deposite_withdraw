...
<div class="row">
 ...
 <div class="container" style="margin-top:50px;margin-bottom:50px;">
    ...
    <div class="row">
        <div class="col"><center><i class="fas fa-shopping-cart fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description shops_1'); ?></center>
        </div>
          <div class="col"><center><i class="fas fa-code fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description shops_2'); ?></center>
        </div>
          <div class="col"><center><i class="fas fa-money-bill-alt fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description shops_3'); ?></center>
        </div>
      </div>
</div> 