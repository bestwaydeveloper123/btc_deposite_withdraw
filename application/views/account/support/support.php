...
<div class="container" style="margin-top:50px;margin-bottom:50px;">
    ...
    <div class="row">
        <div class="col"><center><i class="far fa-question-circle fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description support_1'); ?></center>
        </div>
          <div class="col"><center><i class="fas fa-bullhorn fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description support_2'); ?></center>
        </div>
          <div class="col"><center><i class="icon-support NavIcon fa-2x" style="color:#7e57c2"></i></center><br><center><?php echo lang('users description support_3'); ?></center>
        </div>
      </div>
</div> 