...
<div class="row">
  ...
  <div class="col-md-4 mb-2 text-right">
    <a href="#" <?php /* href="#search" data-toggle="collapse" href="#search" aria-expanded="false" aria-controls="search" */ ?> class="btn btn-outline-secondary btn-sm" id="btn_search"><i class="icon-magnifier icons"></i> <?php echo lang('users trans search'); ?></a>
  </div>
</div>
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="mb-3" id="search" style="display:none;">
          <div class="card card-body">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                <label for="id"><?php echo lang('users trans datefrom'); ?></label>
                <?php echo form_input(array('name'=>'timefrom', 'id'=>'timefrom', 'class'=>'form-control datepicker-here', 'placeholder'=> 'YYYY-MM-DD',  'value'=>set_value('timefrom', ((isset($filters['timefrom'])) ? $filters['timefrom'] : '')))); ?>
              </div>
                <div class="form-group col-md-4">
                <label for="id"><?php echo lang('users trans dateto'); ?></label>
                <?php echo form_input(array('name'=>'timeto', 'id'=>'timeto', 'class'=>'form-control datepicker-here', 'placeholder'=> 'YYYY-MM-DD',  'value'=>set_value('timeto', ((isset($filters['timeto'])) ? $filters['timeto'] : '')))); ?>
              </div>
              <div class="form-group col-md-4">
              ...
              <?php if ($total) : ?>
                ...
                <tr>
                  ...
                  <td>
                    <?if($view['type']==1){?>
                               ...
                               <?if($view['type']==5){?>
                                ...
                                <?}?>
                                <?if($view['type']==6){?>
                                  <?php echo lang('users trans referral'); ?>
                                <?}else{?>
                                <?}?>
                  </td>
                  <td><?php 
                  ...
                  if($view['currency']=='debit_extra5') {
                    $tmp = $this->notice->check_amount_transaction($view['sum'], $view['amount'], $view['fee'], $view['sender'], $view['receiver'], $view['type'], $user['username'], $view['id'], '1');
                  } else {
                    $tmp = $this->notice->check_amount_transaction($view['sum'], $view['amount'], $view['fee'], $view['sender'], $view['receiver'], $view['type'], $user['username'], $view['id']);
                  }
                  echo $tmp; 
                  ...
                  <td><?php //print($view['sender'].'->'.$view['receiver']); print_r($user['username']);?>
                    <?if($view['status']==1){?>
                                ...
                                <?}else{?>
                                <?}?>
                                <?if($view['status']==6 && $view['sender'] == $user['username']){?>
                                  <span class="badge badge-success"> <?php echo lang('users trans success'); ?> </span>
                                <?}else{?>
                                <?}?>
                                <?if($view['status']==6 && $view['receiver'] == $user['username']){?>
                                  <span class="badge badge-danger"> <?php echo lang('users trans limit'); ?> </span>
                                <?}else{?>
                                <?}?>
                  </td>
