...
<?php if ($transactions['status'] == 6 & $transactions['receiver'] == $user['username']) : ?>
<div class="row">
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-md-12 alert alert-danger text-white">
              <p><?php echo lang('users transfer info_limit'); ?> - <a href="/account/limits" style="color:white">CHECK LIMITS</a></p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="form-group">
              <label><?php echo lang('users history dispute_title'); ?></label>
                <select class="form-control" name="title">
                  ...
                  <option value="3"><?php echo lang('users history not_authorized'); ?></option>
                </select>
            </div>
          </div>
          <div class="col-md-12">
