  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-title">
        <div class="row">
          <div class="col-md-4">
            <?php echo lang('admins button rejected_disputes'); ?>
          </div>
            ...
            <table class="table table-responsive-lg table-bordered table-hover">
              ...
              <?php // data rows ?>
                ...
                <tr>
                  ...
                  <td>
                    <?php if($dispute['title'] == 1){?>
                    <?php echo lang('admin disputes not_received'); ?>
                    <?}else{?>
                    <?}?><?php if($dispute['title'] == 2){?>
                      <?php echo lang('admin disputes not_desk'); ?>
                    <?}else{?>
                    <?}?><?php if($dispute['title'] == 3){?>
                      <?php echo lang('admin disputes not_authorized'); ?>
                    <?}else{?>
                    <?}?>
                  </td>
                  <td>
                  ...
                  <td class="-text-center">
                      <a href="<?php echo base_url();?>admin/disputes/detail/<?php echo $dispute['id']; ?>" class="btn btn-sm btn-primary"><i class="icon-eye icons"></i></a>
                  </td>
