              ...
              <div class="tab-pane fade show active" id="v-pills-overview" role="tabpanel" aria-labelledby="v-pills-overview-tab">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                      <?php echo form_label(lang('admin user bday'), 'bday', array('class'=>'control-label')); ?>
                      <span class="required">*</span>
                      <?php echo form_input(array('name'=>'bday', 'value'=>set_value('', (isset($user['bday']) ? $user['bday'] : '')), 'class'=>'form-control form-control-sm')); ?>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <?php echo lang('admins trans id'); ?>
                        ...
                        <tbody>
                          <?php foreach($transaction_user->result() as $view) :
                            ...
                            if ($view->currency == 'debit_extra5') {
                              $view->sum = number_format($view->sum, 8, '.', '');
                            } else {
                              $view->sum = number_format($view->sum, 2, '.', '');
                            }
