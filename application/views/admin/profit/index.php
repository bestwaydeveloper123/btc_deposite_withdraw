                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <?php echo form_input(array('name'=>'start_date', 'id'=>'start_date', 'class'=>'datepicker-here form-control form-control-sm', 'placeholder'=>'2018-02-16', 'value'=>set_value('start_date', ((isset($filters['start_date'])) ? $filters['start_date'] : '')))); ?>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label"><?php echo lang('admin profit 16'); ?></label>
                        <?php echo form_input(array('name'=>'end_date', 'id'=>'end_date', 'class'=>'datepicker-here form-control form-control-sm', 'placeholder'=>'2018-02-17', 'value'=>set_value('end_date', ((isset($filters['end_date'])) ? $filters['end_date'] : '')))); ?>
                      </div>
                    </div>
