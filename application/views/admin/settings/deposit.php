                        ...
                        <tr>
                          <td class="-text-center">
                            ...
                            <?php elseif ($method['id'] == 8) : ?>
                              <img src="<?php echo base_url();?>assets/themes/modular/img/pay-icon/yandex.png" class="img-circle">
                            <?php elseif ($method['id'] == 9) : ?>
                              <img src="<?php echo base_url();?>assets/themes/modular/img/pay-icon/epay.png" class="img-circle">
