  ...
  <div class="col-md-2">
    <div class="card">
      <div class="nav flex-column nav-pills" id="user_menu" role="tablist" aria-orientation="vertical">
        ...
        <?php if ($method_id != 10 &&  $method_id != 9) { ?>
              ...
              <div class="tab-pane fade show active" id="v-pills-overview" role="tabpanel" aria-labelledby="v-pills-overview-tab">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <?php if ($method_id != 10 ) { ?>
                  <div class="col-md-6" <?php if ($method_id == 8) {?> style="display: none;"  <?php } ?> >
                    <div class="form-group">
                      <?php if ($method['id']=="9") { ?>
                        <label><?php echo lang('admin deposit account_pp_epay'); ?> </label>
                      <?php } else { ?>
                  ...
                  <div class="col-md-6" <?php if ($method_id == 8) {?> style="display: none;"  <?php } ?>>
                    <div class="form-group">
                       <?php if ($method['id']=="9") { ?>
                        <label><?php echo lang('admin deposit account_pp_epay_api'); ?> </label>
                      <?php } else { ?>
                      <label><?php echo lang('admin deposit account_pp'); ?></label>
                      <?php } ?>
                      <span class="required">*</span>
                      <?if($method['id']=="7"){?>
