            ...
            <table class="table table-responsive-lg table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center" width="10%">
                   <?php echo lang('admin template usershow'); ?>  
                  </th>
                  <th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="-text-center">
                      <a href="<?php echo base_url();?>admin/template/edit_sms/<?php echo $view['id']; ?>" class="btn btn-sm btn-primary"><i class="icon-eye icons"></i></a>
                  </td>
