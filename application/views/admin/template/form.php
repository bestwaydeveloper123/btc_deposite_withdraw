      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12">
            <div class="form-group">
                <label><?php echo lang('admin template usershow'); ?> </label>
                <span class="required">*</span>
                <select class="form-control form-control-sm" name="user_enabled">
                  <option value="0" <?if($email_templates['user_enabled']=="0"){?>selected<?}else{?><?}?>><?php echo lang('admin template disabled'); ?></option>
                  <option value="1" <?if($email_templates['user_enabled']=="1"){?>selected<?}else{?><?}?>><?php echo lang('admin template enabled'); ?></option>
                </select>
            </div>
          </div>
          <div class="col-md-12">
