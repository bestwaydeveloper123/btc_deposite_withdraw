           ...
           <div class="col-md-12">
            <div class="form-group">
                ...
                <select class="form-control form-control-sm" name="user_enabled">
                  <option value="0" <?if($sms_templates['user_enabled']=="0"){?>selected<?}else{?><?}?>><?php echo lang('admin template disabled'); ?></option>
                  <option value="1" <?if($sms_templates['user_enabled']=="1"){?>selected<?}else{?><?}?>><?php echo lang('admin template enabled'); ?></option>
                </select>
            </div>
          </div>
          <div class="col-md-12">
