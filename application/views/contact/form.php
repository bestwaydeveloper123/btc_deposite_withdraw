              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12 text-right">
                      <button type="submit" name="submit" class="btn btn-success"><?php echo lang('contact button send'); ?></button>
                  </div>
                </div>
              </div>
              <?php echo form_close(); ?>
...
<div class="container">
			<div class="row mt-10">
				...
				<div class="col-md-12 mt-5">
					<h5 class="text-center">BANKAERO LTD</h5>
					<h5 class="text-center"><?php echo lang('contact title company_number'); ?>: 11409306</h5>
					<h5 class="text-center">
						<?php echo lang('contact title legal_address'); ?>: 71-75 Shelton Street, Covent Garden, London, WC2H 9JQ, United Kingdom
					</h5>
				</div>
        ...
        <div class="col-md-4 mt-5">
              ...
              <i class="icon-phone icons text-primary"></i>
						...
						<h5 class="mt-3">+371 <?php echo $this->settings->phone; ?></h5>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 mt-4 mb-4">
						<h4 class="text-center">
							<a href="/user/register" class="btn btn-success btn-lg"><?php echo lang('contact title sign'); ?></a>
						</h4>
					</div>
				</div>
			</div>
