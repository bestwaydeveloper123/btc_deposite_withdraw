...
class Cards extends Private_Controller {
    ...
    function __construct()
    {
        ...
        define('THIS_URL', base_url('account/cards'));
    ...
    */
	function index()
	{
        ...
        $this->set_title(sprintf(lang('users cards cards'), $this->settings->site_name));
        ...
        // load views
        $data['content'] = $this->load->view('account/cards/index', $content_data, TRUE);
