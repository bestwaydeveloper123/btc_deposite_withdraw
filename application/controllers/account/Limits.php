...
class Limits extends Private_Controller {
    ...
    */
	function index()
	{
        ...
        $this->set_title(sprintf(lang('users limits limits'), $this->settings->site_name));
        ...
        // load views
        $data['content'] = $this->load->view('account/limits/index', $content_data, TRUE);
