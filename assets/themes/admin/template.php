            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="<?php echo (uri_string() == 'admin/settings') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/settings'); ?>"><?php echo lang('admin button settings'); ?></a></li>
										<li class="dropdown<?php echo (uri_string() == 'admin/settings') ? 'active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button users'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/settings') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/settings'); ?>"><?php echo lang('admin title setings'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/settings/withdrawal') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/settings/withdrawal'); ?>"><?php echo lang('admin settings withdrawal'); ?></a></li>
                        </ul>
                    </li>
                </ul>
                <?php // Nav bar right ?>
